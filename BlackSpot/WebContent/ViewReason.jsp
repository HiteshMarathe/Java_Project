        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right">Crime</i></h4>
              <hr>
              <table class="table">
                <thead>
                  <tr>
...
try{
	...
	String sql ="select * from spot where Reasontype='Crime'";
...
%>
            ...
            <div class="content-panel">
              <h4><i class="fa fa-angle-right">Accident</i></h4>
              <hr>
              <table class="table">
                <thead>
                  <tr>
...
try{
	Connection con=DBConnection.connect();
	String sql ="select * from spot where Reasontype='Accident'";
